...
- `rehype-external-links` — any external link (including ones that failed to become an OGP card) opens in a new tab (`target="_blank" rel="noopener noreferrer"`); links back to this site are excluded
